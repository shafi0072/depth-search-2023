...
import {TeamData} from '@/src/constant/Team/TeamData'
const Team = () => {
    return (
        <section class="  mt-4">
                ...
                <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    
                    {
                        ...
                        <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={items.image} alt="Bonnie Avatar"/>
                            ...
                            <p className='uppercase text-sm'>{items.position}</p>
                            <ul class="flex justify-center mt-4 space-x-4">
                                <li>
                                    <a href={items.facebook} target='_blank' class="text-[#39569c] hover:text-gray-900 dark:hover:text-white">
